...
//                   $nombreempleado=$Lista[$k]["NOMBRE_EMPLEADO"];
		  ...
		  ?>
			  <tr class="table-row">
                                ...
                                <td contenteditable="false" onBlur="saveToDatabase(this,'NOMBRE_EMPLEADO','<?php echo $filas["ID_INFORME_GERENCIAL"]; ?>')" onClick="showEdit(this);"><?php echo $filas["NOMBRE_EMPLEADO"]; ?></td>
