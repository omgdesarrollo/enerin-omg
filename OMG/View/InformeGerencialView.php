...
//                   $nombreempleado=$Lista[$k]["NOMBRE_EMPLEADO"];
		  ...
		  ?>
			  <tr class="table-row">
                                ...
                                <td contenteditable="false" onBlur="saveToDatabase(this,'fecha_alarma','<?php echo $filas["id_informe_gerencial"]; ?>')" onClick="showEdit(this);"><?php echo $filas["fecha_alarma"]; ?></td>
