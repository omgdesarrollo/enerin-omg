...
--
-- Table structure for table `cumplimientos`
--
...
--
-- Dumping data for table `cumplimientos`
--

LOCK TABLES `cumplimientos` WRITE;
/*!40000 ALTER TABLE `cumplimientos` DISABLE KEYS */;
INSERT INTO `cumplimientos` VALUES (1,'CUMPLIMIENTO 1','PRUEBA',0),(2,'CUMPLIMIENTO 2','PRUEBA1',0);
