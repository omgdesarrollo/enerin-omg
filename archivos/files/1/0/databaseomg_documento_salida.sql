...
--
-- Table structure for table `documento_salida`
--
...
--
-- Dumping data for table `documento_salida`
--

LOCK TABLES `documento_salida` WRITE;
/*!40000 ALTER TABLE `documento_salida` DISABLE KEYS */;
INSERT INTO `documento_salida` VALUES (0,0,'','0000-00-00','','','','');
